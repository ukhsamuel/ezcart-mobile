      ...
      <View className="flex-row">
        ...
        <View className="basis-9/12 pl-4 justify-center">
          <View className="flex-row space-x-4">
            ...
            <View className="bg-green-100 rounded-lg p-1 w-16 items-center justify-center">
              <Text className="text-orange-400 text-sm">Default</Text>
            </View>
          </View>
          <Text
            numberOfLines={2}
        ...
        <View className="basis-1/12 justify-center ">
          <Ionicons name="chevron-forward" color={COLORS.primary} size={32} />
        </View>
      </View>
    </View>
  );
  ...
  return (
    <View className="bg-white shadow-zinc-50 p-4 flex-col space-y-4 rounded-2xl">
      <View className="flex-row">
        ...
        <TouchableOpacity className="rounded-2xl border  items-center border-orange-400 bg-white p-1">
              <Text className="text-xs text-orange-400">Add Items</Text>
            </TouchableOpacity>
        </View>
      </View>
    ...
    <View className="flex-row border-t py-4 border-gray-200">
      ...
      <View className="basis-2/12 justify-center space-y-2 items-end flex-col">
        ...
        <TouchableOpacity className="items-center">
          <Ionicons name="pencil" color={COLORS.primary} size={24} />
        </TouchableOpacity>
      </View>
    </View>
  );
...
const StoreCheckout = ({ navigation }) => {
  return (
    <SafeAreaView className="bg-gray-50 flex-1 pb-8">
      <MembersHeader title="Checkout Orders" showBackButton={true} />
      <ScrollView
